...
class _ImageBuilderPipeline(task.Task):
    ...
    def __init__(self, task_id, task_type, uri, action_wrapper, stores):
        ...
        self.stores = stores
        self._path = None
        super(_ImageBuilderPipeline, self).__init__(
            name='%s-ImageBuilderPipeline-%s' % (task_type, task_id))
    ...
    def revert(self, result, **kwargs):
        ...
        if self._path is not None:
            ...
            try:
                ...
                LOG.exception(_LE("Error reverting _ImageBuilderPipeline "
                                  "task: %(task_id)s"), {
                    'task_id': self.task_id})


def get_flow(**kwargs):
    """Return task flow for _ImageBuilderPipeline.
    ...
    return lf.Flow(task_type).add(
        _ImageBuilderPipeline(task_id, task_type, uri, action_wrapper, stores),
    )
